...
import com.gestion.clientes.exception.ResourcesNotFoundException;
...
public class ClienteController {
    ...
    public ResponseEntity<Cliente> listarClientePorId(@PathVariable Long id) {
        Cliente cliente = clienteRepository.findById(id)
            .orElseThrow(() -> new ResourcesNotFoundException("El cliente con ese ID no existe : " + id));
    ...
    public ResponseEntity<Map<String, Boolean>> borrarCliente(@PathVariable Long id) {
        Cliente cliente = clienteRepository.findById(id)
            .orElseThrow(() -> new ResourcesNotFoundException("El cliente con ese ID no existe : " + id));
